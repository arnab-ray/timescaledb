...
CREATE TABLE hyper_ts ("time_broken" timestamptz NOT NULL, "device_id" text, "value" integer);
...
INSERT INTO hyper_ts (time, device_id, value) SELECT to_timestamp(g), 'dev' || g, g FROM generate_series(0,30) g;

--one in the future
INSERT INTO hyper_ts (time, device_id, value)  VALUES ('2100-01-01 02:03:04 PST', 'dev101', 0);
